...
<html lang="pt-br">
    ...
    <section id="imagem-fundo" class="container-fluid">
      ...
      <form method="post" class="col-lg-3" action="">
        ...
        <input
          ...
          class="form-control"
          id="primeira"
          placeholder="Primeira Opção de Graduação"
          required
        /><br />
        <input
          type="text"
        ...
        <div>
          <label id="checkboxForm" class="checkbox-inline"
            ><input type="checkbox" value="" required />Aceito o Termo
            LGPD</label
          >
        </div>
        <br />
        ...
        <div>
          <a id="corLink" href="http://www.upf.br" target="_blank"
            >Clique aqui para ler o Termo LGPD</a
          >
        </div>
        <br />
    ...
    <section class="container-fluid col-lg-12">
      ...
      <div id="imgredesSociais" class="col-lg-2">
        <a href="https://www.instagram.com/universidadeupf/" target="_blank">
          <img src="midea/img/instagram.png" alt=""
        /></a>
        <a
          href="https://www.facebook.com/universidadedepassofundo"
          target="_blank"
          ><img src="midea/img/facebook.png" alt=""
        /></a>
        <a href="https://www.linkedin.com/edu/school?id=10612" target="_blank"
          ><img src="midea/img/linkedin.png" alt=""
        /></a>
        <a
          href="https://www.flickr.com/universidadedepassofundo/"
          target="_blank"
          ><img class="imgRedes" src="midea/img/flickr.png" alt=""
        /></a>
        <a href="https://www.youtube.com/UPFoficial" target="_blank"
          ><img src="midea/img/youtube.png" alt=""
        /></a>
        <a href="https://twitter.com/universidadeupf" target="_blank"
          ><img src="midea/img/twitter.png" alt=""
        /></a>
        <a href="https://wa.me/5554912839821" target="_blank"
          ><img src="midea/img/whatsapp.png" alt=""
        /></a>
      </div>
    </section>
  </body>
  ...
  <link
    rel="stylesheet"
    href="https://cdn.privacytools.com.br/public_api/banner/style/zGGa615171.css?t=1"
  />
  <script
    type="text/javascript"
    src="https://cdn.privacytools.com.br/public_api/banner/script/bottom/zGGa615171.js?t=1"
  ></script>
  <script>
    AOS.init({
      duration: 600
